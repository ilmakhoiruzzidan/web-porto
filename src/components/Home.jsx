  ...
  return (
    <div name='home' className='w-full h-screen bg-[#DAD7CD]'>
        ...
        <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
            ...
            <p className='text-[#3a5a40d5] py-4 max-w-[700px]'>I am interested in web development. I have experience of doing a wordpress development from my past internship. 
            I will be seeking a new opportunity and be able to adapt to learn new skills and technology.</p>
            <div>
